  ...
  (match* (e1 e2)
    ...
    [((cons kw1 args1)
     ...
     #:when (and (symbol? kw1) (symbol? kw2)
                 (not (or (eqv? kw1 'λ) (eqv? kw1 'λi) (eqv? kw1 'Π) (eqv? kw1 'Πi) (eqv? kw1 'Σ) (eqv? kw1 'TODO)))
                 (not (or (eqv? kw2 'λ) (eqv? kw2 'λi) (eqv? kw2 'Π) (eqv? kw2 'Πi) (eqv? kw2 'Σ) (eqv? kw2 'TODO)))
